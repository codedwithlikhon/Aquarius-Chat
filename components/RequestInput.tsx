        ...
        <div className="p-3 bg-black">
            <form onSubmit={handleSubmit} className="relative">
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2">
                     <button type="button" className="p-1 text-gray-400 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed" disabled={disabled}>
                        <PaperclipIcon className="w-5 h-5" />
                    </button>
                    <button type="button" className="p-1 ml-1 text-gray-400 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed" disabled={disabled}>
                        <MicrophoneIcon className="w-5 h-5" />
                    </button>
                    <button type="submit" className="p-1 ml-1 text-gray-400 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed" disabled={!query.trim() || disabled}>

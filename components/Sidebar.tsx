...
const StatusCard: React.FC<{ status: string; isCompleted: boolean; onStop: () => void; onReset: () => void; isRunning: boolean; }> = ({ status, isCompleted, onStop, onReset, isRunning }) => (
...
export const Sidebar: React.FC<{ 
    ...
    return (
        <div className="w-full md:w-1/3 md:max-w-sm flex flex-col border-r border-gray-700/50 bg-black h-full">
            <div className="flex-1 p-4 space-y-4 overflow-y-auto">
                ...
                {showStatus && <StatusCard status={status} isCompleted={isCompleted} onStop={onStop} onReset={onReset} isRunning={isAgentRunning} />}
            </div>
